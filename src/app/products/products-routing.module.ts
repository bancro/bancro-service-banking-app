  ...
  Route.withShell([
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              path: ":productId",
              data: {
                title: extract("View Saving Product"),
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              path: ":productId",
              data: {
                title: extract("View Share Product"),
                breadcrumb: "productId",
                routeParamBreadcrumb: "productId",
              },
              resolve: {
        ...
        },
        {
          ...
          data: {
            title: extract("Manage Delinquency Bucket Configurations"),
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      path: "edit",
                      data: {
                        title: extract("Edit Delinquency Range"),
                        breadcrumb: "Edit",
                        routeParamBreadcrumb: false,
                      },
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      path: "edit",
                      data: {
                        title: extract("Edit Delinquency Bucket"),
                        breadcrumb: "Edit",
                        routeParamBreadcrumb: false,
                      },
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              path: ":productId",
              data: {
                title: extract("View Recurring Deposit Product"),
                breadcrumb: "productId",
                routeParamBreadcrumb: "productId",
              },
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              path: ":productId",
              data: {
                title: extract("View Fixed Deposit Product"),
                breadcrumb: "productId",
                routeParamBreadcrumb: "productId",
              },
        ...
        {
          path: "custom-fixed-deposit-products",
          component: FixedDepositProductsComponent,
          data: { title: extract("Fixed Deposit Products"), breadcrumb: "Custom Fixed Deposit Products" },
          resolve: {
            fixedDepositProducts: FixedDepositProductsResolver,
          },
        },
