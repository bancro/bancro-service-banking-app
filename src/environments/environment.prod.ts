...
export const environment = {
  ...
  baseApiUrls:
    ...
    "https://fineract-cowry-app-prod.ambitiousbay-699a0adb.eastus2.azurecontainerapps.io,https://dev.mifos.io,https://demo.mifos.io,https://qa.mifos.io,https://staging.mifos.io,https://mobile.mifos.io,https://demo.fineract.dev,https://localhost:8443",
  // For connecting to server running elsewhere set the base API URL
  baseApiUrl: window["env"]["baseApiUrl"] || "https://fineract-cowry-app-prod.ambitiousbay-699a0adb.eastus2.azurecontainerapps.io",
