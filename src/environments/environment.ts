...
export const environment = {
  ...
  baseApiUrls: window['env']['fineractApiUrls'] ||
    'https://corelex.royalexchangemfb.com:8443,https://dev.mifos.io,https://demo.mifos.io,https://qa.mifos.io,https://staging.mifos.io,https://mobile.mifos.io,https://demo.fineract.dev,https://localhost:8443',
  // For connecting to server running elsewhere set the base API URL
  baseApiUrl: window['env']['baseApiUrl'] || 'https://corelex.royalexchangemfb.com:8443',
