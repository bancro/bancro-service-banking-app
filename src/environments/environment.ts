...
export const environment = {
  ...
  baseApiUrls: window['env']['fineractApiUrls'] ||
    'https://fineract-cowry-app.yellowstone-f096dd2c.eastus.azurecontainerapps.io,https://dev.mifos.io,https://demo.mifos.io,https://qa.mifos.io,https://staging.mifos.io,https://mobile.mifos.io,https://demo.fineract.dev,https://localhost:8443',
  // For connecting to server running elsewhere set the base API URL
  baseApiUrl: window['env']['baseApiUrl'] || 'https://fineract-cowry-app.yellowstone-f096dd2c.eastus.azurecontainerapps.io',
